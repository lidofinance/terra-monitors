...
func (m *BlockHeader) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateAppHash(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateConsensusHash(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateDataHash(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateEvidenceHash(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateLastCommitHash(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateLastResultsHash(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateNextValidatorsHash(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateProposerAddress(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateValidatorsHash(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *BlockHeader) contextValidateAppHash(ctx context.Context, formats strfmt.Registry) error {

	if err := m.AppHash.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("app_hash")
		}
		return err
...
func (m *BlockHeader) contextValidateConsensusHash(ctx context.Context, formats strfmt.Registry) error {

	if err := m.ConsensusHash.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("consensus_hash")
		}
		return err
...
func (m *BlockHeader) contextValidateDataHash(ctx context.Context, formats strfmt.Registry) error {

	if err := m.DataHash.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("data_hash")
		}
		return err
...
func (m *BlockHeader) contextValidateEvidenceHash(ctx context.Context, formats strfmt.Registry) error {

	if err := m.EvidenceHash.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("evidence_hash")
		}
		return err
...
func (m *BlockHeader) contextValidateLastCommitHash(ctx context.Context, formats strfmt.Registry) error {

	if err := m.LastCommitHash.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("last_commit_hash")
		}
		return err
...
func (m *BlockHeader) contextValidateLastResultsHash(ctx context.Context, formats strfmt.Registry) error {

	if err := m.LastResultsHash.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("last_results_hash")
		}
		return err
...
func (m *BlockHeader) contextValidateNextValidatorsHash(ctx context.Context, formats strfmt.Registry) error {

	if err := m.NextValidatorsHash.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("next_validators_hash")
		}
		return err
...
func (m *BlockHeader) contextValidateProposerAddress(ctx context.Context, formats strfmt.Registry) error {

	if err := m.ProposerAddress.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("proposer_address")
		}
		return err
...
func (m *BlockHeader) contextValidateValidatorsHash(ctx context.Context, formats strfmt.Registry) error {

	if err := m.ValidatorsHash.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("validators_hash")
		}
		return err
