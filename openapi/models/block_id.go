...
func (m *BlockID) contextValidateHash(ctx context.Context, formats strfmt.Registry) error {
...
// ContextValidate validate this block ID parts based on the context it is used
...
func (m *BlockIDParts) contextValidateHash(ctx context.Context, formats strfmt.Registry) error {
