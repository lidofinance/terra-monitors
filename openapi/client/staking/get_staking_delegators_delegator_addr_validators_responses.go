...
// ContextValidate validate this get staking delegators delegator addr validators o k body based on the context it is used
func (o *GetStakingDelegatorsDelegatorAddrValidatorsOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *GetStakingDelegatorsDelegatorAddrValidatorsOKBody) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
